...
public class AddBibl extends XMLWriter {

    private String originalName;
    private boolean inDiv, inAB, inW, hasBIBL;
    private final Syllabicator syl;
    private final StringModifier sm;

    public AddBibl(String f, XMLReader x) {
        super(x);
        originalName = f;
    ...
    public static void main(String[] args) throws Exception {
        ...
        AddBibl l = new AddBibl(input, XMLReaderFactory.createXMLReader());
        l.save(out);
