...
public class XMLWriter extends XMLFilterImpl
{
    ...
    public void superStartDocument() throws SAXException {
        super.startDocument();
    }
    ...
    /**
     * Pass the event on down the filter chain for further processing without
     * writing the data
     *
     * @param ch The array of characters to write.
     * @param start The starting position in the array.
     ...
     * @see org.xml.sax.ContentHandler#characters
     */
    protected void superCharacters(char ch[], int start, int len) 
        throws SAXException 
    {
        super.characters(ch, start, len);
    }
     ...
     */
    protected void writeName (String uri, String localName,
